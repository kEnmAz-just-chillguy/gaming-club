...
import { Monitor, Clock, ArrowLeft, Gamepad2, DollarSign, Wrench, Search } from 'lucide-react';
  ...
  return (
    <div className="page-content fade-in">
      ...
      <div style={{ marginBottom: 28 }}>
        <h1 style={{ fontFamily: 'Orbitron, sans-serif', fontSize: 22, fontWeight: 800 }}>All Rooms</h1>
